...
/**
 * Jersey REST client generated for REST resource:we [Ficha]<br>
 * USO:
 * <pre>
...
public class FichaClient {
     ...
     */
    public <T> T ficha1(Class<T> responseType, String orden) throws ClientErrorException {
        String[] queryParamNames = new String[]{"movimiento"};
        String[] queryParamValues = new String[]{orden};
        ;
